...
export type Position = {
  ...
  id: Scalars['ID']['output'];
  incentiveId?: Maybe<Scalars['Bytes']['output']>;
  liquidity: Scalars['BigInt']['output'];
  oldOwner?: Maybe<Scalars['Bytes']['output']>;
  owner: Scalars['Bytes']['output'];
...
export enum PositionSnapshot_OrderBy {
  ...
  PositionIncentiveId = 'position__incentiveId',
...
export const GetIncentiveDocument = gql`
 ...
 * });
 */
export function useGetIncentiveQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetIncentiveQuery,
    GetIncentiveQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetIncentiveQuery, GetIncentiveQueryVariables>(
    GetIncentiveDocument,
    options,
  );
}
export function useGetIncentiveLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetIncentiveQuery, GetIncentiveQueryVariables>(
    GetIncentiveDocument,
    options,
  );
}
export type GetIncentiveQueryHookResult = ReturnType<
  typeof useGetIncentiveQuery
>;
export type GetIncentiveLazyQueryHookResult = ReturnType<
  typeof useGetIncentiveLazyQuery
>;
export type GetIncentiveQueryResult = Apollo.QueryResult<
  GetIncentiveQuery,
  GetIncentiveQueryVariables
>;
export const GetPoolInfoDocument = gql`
...
/**
 * __useGetPoolInfoQuery__
 *
 * To run a query within a React component, call `useGetPoolInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPoolInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPoolInfoQuery({
 *   variables: {
 *      poolId: // value for 'poolId'
 *   },
 * });
 */
export function useGetPoolInfoQuery(
  baseOptions: Apollo.QueryHookOptions<
    GetPoolInfoQuery,
    GetPoolInfoQueryVariables
  >,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetPoolInfoQuery, GetPoolInfoQueryVariables>(
    GetPoolInfoDocument,
    options,
  );
}
export function useGetPoolInfoLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetPoolInfoQuery,
    GetPoolInfoQueryVariables
  >,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetPoolInfoQuery, GetPoolInfoQueryVariables>(
    GetPoolInfoDocument,
    options,
  );
}
export type GetPoolInfoQueryHookResult = ReturnType<typeof useGetPoolInfoQuery>;
export type GetPoolInfoLazyQueryHookResult = ReturnType<
  typeof useGetPoolInfoLazyQuery
>;
export type GetPoolInfoQueryResult = Apollo.QueryResult<
  GetPoolInfoQuery,
  GetPoolInfoQueryVariables
>;
